<?php session_start(); ob_start(); require('core/Database.php'); $db = new Database(); if (!isset($_SESSION['user'])) { header("Location: index.php"); } ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <meta name="author" content="Niko Mitov Tony Beliyashki">
    ...
    <body>
        <div id="wrap">
            ...
            <div id="footer">
                Secure File Sharing System 2015 &copy;
            </div>
        </div>
    </body>
</html>
